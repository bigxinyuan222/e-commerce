...
var MessagePage = function MessagePage() {
        ...
        case 3:
          ...
          result = convData.map(function (conv) {
            ...
            return {
              ...
              time: (0,_utils__WEBPACK_IMPORTED_MODULE_12__.formatMessageTime)((_ref16 = (_ref17 = (_ref18 = (_ref19 = (_conv$lastTime = conv.lastTime) !== null && _conv$lastTime !== void 0 ? _conv$lastTime : conv.LastTime) !== null && _ref19 !== void 0 ? _ref19 : conv.time) !== null && _ref18 !== void 0 ? _ref18 : conv.UpdatedAt) !== null && _ref17 !== void 0 ? _ref17 : conv.updatedAt) !== null && _ref16 !== void 0 ? _ref16 : ''),
  ...
  var serviceUnread = serviceConvs.reduce(function (sum, c) {
    return sum + (c.unreadCount || 0);
  }, 0);
  var latestService = serviceConvs[0];
