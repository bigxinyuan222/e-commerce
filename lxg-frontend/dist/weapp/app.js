...
var config = {"pages":["pages/home/index","pages/category/index","pages/message/index","pages/cart/index","pages/user/mine/index","pages/home/detail/index","pages/home/evaluations/index","pages/home/search/index","pages/home/search-results/index","pages/home/seckill/index","pages/home/brands/index","pages/home/brand-detail/index","pages/cart/checkout/index","pages/cart/order/list/index","pages/cart/order/detail/index","pages/cart/order/refund/index","pages/cart/order/refund-list/index","pages/cart/order/review/index","pages/user/login/index","pages/user/profile/index","pages/user/personal-info/index","pages/user/account-name/index","pages/user/coupons/index","pages/message/customer-service/index","pages/category/stores/index","pages/category/store-detail/index"],"window":{"backgroundTextStyle":"light","navigationBarBackgroundColor":"#ffffff","navigationBarTitleText":"乐享购","navigationBarTextStyle":"black","backgroundColor":"#f5f6f7"},"tabBar":{"color":"#666666","selectedColor":"#e2231a","backgroundColor":"#ffffff","borderStyle":"black","list":[{"pagePath":"pages/home/index","text":"首页"},{"pagePath":"pages/category/index","text":"分类"},{"pagePath":"pages/message/index","text":"消息"},{"pagePath":"pages/cart/index","text":"购物车"},{"pagePath":"pages/user/mine/index","text":"我的"}]}};
...
/* harmony export */   patchTaroPureTextNodeBug: function() { return /* binding */ patchTaroPureTextNodeBug; }
/* harmony export */ });
/* harmony import */ var _tarojs_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @tarojs/runtime */ "./node_modules/@tarojs/runtime/dist/dom/element.js");
// ============================================
// Taro 4.x 运行时补丁
 ...
 */
function patchTaroPureTextNodeBug() {
  if (false) {}
  if (installed) return;
  if (!(_tarojs_runtime__WEBPACK_IMPORTED_MODULE_0__.TaroElement !== null && _tarojs_runtime__WEBPACK_IMPORTED_MODULE_0__.TaroElement !== void 0 && _tarojs_runtime__WEBPACK_IMPORTED_MODULE_0__.TaroElement.prototype)) return;
  var proto = _tarojs_runtime__WEBPACK_IMPORTED_MODULE_0__.TaroElement.prototype;
  if (proto.__pureTextPatched) return;
  var origRemove = proto.removeEventListener;
  if (typeof origRemove !== 'function') return;
  proto.removeEventListener = function (type, handler, sideEffect) {
    try {
      ...
      try {
        var _this$__handlers;
        var key = String(type).toLowerCase();
        var handlers = (_this$__handlers = this.__handlers) === null || _this$__handlers === void 0 ? void 0 : _this$__handlers[key];
        if (Array.isArray(handlers)) {
          var idx = handlers.findIndex(function (item) {
            return item === handler || (item === null || item === void 0 ? void 0 : item.oldHandler) === handler;
          });
