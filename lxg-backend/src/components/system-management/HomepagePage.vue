...
const bannerForm = reactive({ id: '' as Id | '', title: '', image: '', linkType: 'none' as LinkType, link: '', sort: 1, status: 'active' as BannerStatus })
const recommendOpen = ref(false)
const recommendSubmitting = ref(false)
const recommendForm = reactive({ name: '', status: 'active' as 'active' | 'inactive' })
const editingRecommendation = ref<Recommendation | null>(null)
const productsLoading = ref(false)
const productSearch = ref('')
const productActionId = ref<Id | null>(null)
...
<style scoped>
.homepage-page{display:flex;flex-direction:column;gap:12px}.homepage-error{padding:10px 12px;border:1px solid #fecaca;border-radius:7px;background:#fef2f2;color:#b91c1c}.homepage-stats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.homepage-stats .value{font-size:22px}.green{color:#22c55e}.blue{color:#4f6ef7}.banner-thumb{width:80px;height:40px;object-fit:cover;border-radius:4px}.link-cell{max-width:180px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.row-actions{display:flex;gap:4px;flex-wrap:wrap}.empty{text-align:center;padding:24px;color:#94a3b8}.homepage-recommend-layout{display:grid;grid-template-columns:minmax(0,2fr) minmax(240px,1fr);gap:12px}.recommend-summary{display:flex;flex-direction:column;gap:8px}.recommend-summary>div{display:flex;align-items:center;justify-content:space-between;padding:8px 12px;border-radius:6px;background:#f8fafc}.homepage-modal{width:min(640px,calc(100vw - 32px))}.recommend-modal{width:min(500px,calc(100vw - 32px))}.products-modal{width:min(860px,calc(100vw - 32px))}.form-stack{display:flex;flex-direction:column;gap:12px;max-height:65vh;overflow:auto}.form-stack label{display:flex;flex-direction:column;gap:5px;color:#64748b;font-size:13px}.form-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}.form-control{width:100%;padding:8px 12px;border:1px solid #e2e8f0;border-radius:6px;background:#fff;color:#1e293b}.banner-preview{width:100%;height:180px;object-fit:cover;border-radius:7px}.muted{color:#64748b;font-size:12px}.product-search-bar{display:flex;gap:8px}.product-search-bar .form-control{flex:1}.product-search-tip{margin:8px 0 14px;color:#64748b;font-size:12px}.recommend-product-table{max-height:52vh;overflow:auto}.recommend-product-table table{min-width:680px}.recommend-product-name{display:flex;align-items:center;gap:9px;min-width:180px}.recommend-product-name img{width:40px;height:40px;border-radius:6px;object-fit:cover}.product-price{color:#ef4444;font-weight:600}.products-modal .modal-footer{justify-content:space-between}.selected-count{color:#64748b;font-size:13px}[data-theme='dark'] .recommend-summary>div,[data-theme='dark'] .form-control{background:#111827;color:#e5e7eb;border-color:#334155}@media(max-width:850px){.homepage-recommend-layout{grid-template-columns:1fr}}@media(max-width:600px){.homepage-stats,.form-grid{grid-template-columns:1fr}.product-search-bar{align-items:stretch;flex-direction:column}}
</style>
