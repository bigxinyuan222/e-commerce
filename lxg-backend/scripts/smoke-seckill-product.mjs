...
await page.route('**/api/**', async route => {
  ...
  if (request.method() === 'GET' && url.pathname === '/api/v1/admin/seckill/activities') {
    data = { activities: [{ ID: 6, name: '待发布活动', startTime: '2026-08-02 10:00', endTime: '2026-08-02 12:00', status: 0, products: [] }, { ID: 7, name: '超时活动', startTime: '2026-08-01 10:00', endTime: '2026-08-01 12:00', status: 4, products: [] }, { ID: 8, name: '已发布活动', startTime: '2026-08-03 10:00', endTime: '2026-08-03 12:00', status: 1, products: [{ product_id: 205, skus: [{ sku_id: 350, seckill_price: 9.9, stock_limit: 500 }] }] }] }
    ...
    data = { activity_id: 8, products: [{ product_id: 205, product_name: '已发布活动商品', normal_price: 19.9, skus: [{ sku_id: 350, seckill_price: 9.9, stock_limit: 500 }] }] }
...
try {
  ...
  const publishedExpected = { activity_id: 8, product_id: 205, skus: [{ sku_id: 350, stock_limit: 20 }] }
